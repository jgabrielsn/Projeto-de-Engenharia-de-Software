...
describe('CRUD Contas', () => {
    it ('Create a new conta', async () => {
        const response = await request('http://localhost:3000').post('/contas').set{'authorization': token}.send({
            UserID: '13',
            contaNome: 'teste',
            valor: '100.50',
            vencimento: '01/01/24',
    ...
    it ('Update conta', async () => {
        const response = await request('http://localhost:3000').put('/contas/78').send({
            UserID: '13',
            contaNome: 'teste',
            valor: '100.50',
            vencimento: '01/01/24',
    ...
    it ('Delete conta', async () => {
        const response = await request('http://localhost:3000').delete('/contas/78');
        expect(response.statusCode).toBe(204);
    });
